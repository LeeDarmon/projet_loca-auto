<?php 
    ...
    echo form_input(array('id'=>'start_date','name'=>'start_date', 'value' => set_value( 'start_date',date('Y-m-d')) , "type" => "date")); 
    ...
    <p > Prix à la journée <span id="forfait"><?= $vehicle[0]['Forfait'];?></span> € </p>
